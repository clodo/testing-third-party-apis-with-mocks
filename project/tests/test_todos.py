...
def test_getting_todos_alternative_one(mock_get):
    # Configure the mock to return a response with OK status code.
...
def test_getting_todos_alternative_two():
...
def test_getting_todos_alternative_three():
...
def test_getting_todos_when_response_is_ok(mock_get):
    ...
    # Configure the mock to return a response with an OK status code. Also, the
    # mock should have a `json()` method that returns a list of todos.
